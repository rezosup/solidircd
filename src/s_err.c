...
static char *replies[] = 
{
   ...
   /* 004 RPL_MYINFO */	        ":%s 004 %s %s %s aAbcCdefFghHiIjkKmnoOrRsvwxXy "
    ...
    /* 194 */	                NULL,
    /* 195 */	                NULL,
   /* 196 RPL_MAP */           ":%s 196 %s :%s%-*s (%d) (%d%)",
    /* 197 RPL_MAPEND */        ":%s 197 %s :End of /MAP",
    /* 198 RPL_MAPMORE */       ":%s 198 :%s%-*s --> *more*",
    /* 199 */	                NULL,
    ...
    /* 479 ERR_BADCHANNAME */   ":%s 479 %s %s :Channel name contains illegal "
                                "characters",
  /* 480 ERR_BANNEDFROMCHAN */	":%s 180 %s %s :Cannot join channel "
                                        "(+S)",
    ...
    /* 488 ERR_BANNEDFROMCHAN */	":%s 180 %s %s :Cannot join channel "
                                        "(+D) Unresolved clients are not permited on this channel.",
    ...
    /* 997 */	                NULL,
    /* 998 */	                NULL,
    /* 999 */		        ":%s 999 %s Numeric error! yikes! !woopie!",
    /* 1000 */	                NULL
};
